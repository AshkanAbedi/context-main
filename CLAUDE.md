...
**AI-integrated German Learning App focused on contextual reading and real-life scenario conversations** ("Context") built with Flutter + Supabase. Early-stage — most features are stubs.
